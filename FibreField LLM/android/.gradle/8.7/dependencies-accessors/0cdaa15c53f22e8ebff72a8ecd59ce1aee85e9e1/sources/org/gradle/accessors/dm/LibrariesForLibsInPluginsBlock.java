...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final MlcLibraryAccessors laccForMlcLibraryAccessors = new MlcLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>mlc</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public MlcLibraryAccessors getMlc() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForMlcLibraryAccessors;
    }
    ...
    public static class AndroidxFragmentLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.fragment</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxSecurityLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.security</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class MlcLibraryAccessors extends SubDependencyFactory {
        private final MlcLlmLibraryAccessors laccForMlcLlmLibraryAccessors = new MlcLlmLibraryAccessors(owner);

        public MlcLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>mlc.llm</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MlcLlmLibraryAccessors getLlm() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMlcLlmLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MlcLlmLibraryAccessors extends SubDependencyFactory {

        public MlcLlmLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>ai.mlc:mlc-llm-android</b> coordinates and
         * with version reference <b>mlc.llm</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final MlcVersionAccessors vaccForMlcVersionAccessors = new MlcVersionAccessors(providers, config);
        ...
        private final SdkVersionAccessors vaccForSdkVersionAccessors = new SdkVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>osmdroid</b> with value <b>6.1.17</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>truth</b> with value <b>1.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.mlc</b>
         */
        public MlcVersionAccessors getMlc() {
            return vaccForMlcVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.sdk</b>
         */
        public SdkVersionAccessors getSdk() {
            return vaccForSdkVersionAccessors;
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.fragment</b> with value <b>1.6.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.security</b> with value <b>1.1.0-alpha06</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MinVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>min.sdk</b> with value <b>24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MlcVersionAccessors extends VersionFactory  {

        public MlcVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>mlc.llm</b> with value <b>0.15.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLlm() { return getVersion("mlc.llm"); }
    ...
    public static class SdkVersionAccessors extends VersionFactory  {

        public SdkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>sdk.version</b> with value <b>34</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("sdk.version"); }
    ...
    public static class TensorflowVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>tensorflow.lite</b> with value <b>2.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>mlkit</b> which contains the following dependencies:
         * <ul>
         *    <li>com.google.mlkit:text-recognition</li>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getMlkit() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("mlkit");
        }
